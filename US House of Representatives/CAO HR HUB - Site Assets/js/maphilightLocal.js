(function (root, factory) {
	...
	if (path.includes("Home") || path.includes("TestPage_05")) {
	...
	} else if (path.includes("TestPage_06") || path.includes("CareerPaths.aspx")) {
	...
	} else if (path.includes("TestPage_07") || path.includes("Administrative")) {
	...
	} else if (path.includes("TestPage_08") || path.includes("Communications")) {
		...
		console.log("Inside TestPage_11 logic");
